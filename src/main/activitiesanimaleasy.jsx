...
const ActivitiesAnimalEasy = () => {
  ...
  const [heartBreakingStage, setHeartBreakingStage] = useState(0); 
  ...
  const [questionResults, setQuestionResults] = useState([null, null, null]); 
...
const saveProgress = async () => {
  ...
  try {
    ...
    const maxGameTimeSeconds = 60; 
    const timeSpent = Math.min(elapsedTime, maxGameTimeSeconds);
...
export default ActivitiesAnimalEasy;