...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        // Prepare and execute the query to get all student progress
        $sql = "SELECT * FROM studentprogress ORDER BY datetime DESC";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $progressData[] = [
                ...
                'name' => $row['name'],
                'day' => $row['day'], // Include the day attribute from studentprogress table
        ...
        error_log("Error in fetchStudentProgress.php: " . $e->getMessage());
        http_response_code(500);
