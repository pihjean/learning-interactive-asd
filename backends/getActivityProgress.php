...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        ...
        // Debug: Log the studentID being requested
        error_log("Fetching activities for student ID: " . $studentID);
        
        // Prepare and execute the query to get activities for specific student
        $sql = "SELECT * FROM activity_progress WHERE studentID = ? ORDER BY datetime DESC";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $formattedDateTime = date('m/d/y', strtotime($row['datetime']));
        ...
        error_log("Error in getActivityProgress.php: " . $e->getMessage());
        http_response_code(500);
        echo json_encode([
            "success" => false, 
